...
We previously saw some of the simple data types built into Python: integers,
floats, strings, etc.  A whole new world is opened up by compound data
types.
...
Python lists follow the C convention of being indexed
